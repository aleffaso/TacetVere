...
var form_fuel = "<br><select class='form-fuel form-control' name='emission_one'>" + 
                        ...
                        "<option value='carvao-vapor-one-kcal-kg'>Carvão Vapor 3100 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-two-kcal-kg'>Carvão Vapor 3300 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-three-kcal-kg'>Carvão Vapor 3700 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-four-kcal-kg'>Carvão Vapor 4200 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-five-kcal-kg'>Carvão Vapor 4500 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-six-kcal-kg'>Carvão Vapor 4700 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-seven-kcal-kg'>Carvão Vapor 5200 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-eight-kcal-kg'>Carvão Vapor 5900 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-nine-kcal-kg'>Carvão Vapor 6000 kcal / kg (Toneladas)</option>" +
...
const form_fuel_two =  "<br><select class='form-fuel-two form-control' name='emission_two'>" +
                        ...
                        "<option value='carvao-vapor-3700-kcal'>Carvão Vapor 3700 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-4200-kcal'>Carvão Vapor 4200 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-4500-kcal'>Carvão Vapor 4500 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-4700-kcal'>Carvão Vapor 4700 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-5200-kcal'>Carvão Vapor 5200 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-5900-kcal'>Carvão Vapor 5900 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-6000-kcal'>Carvão Vapor 6000 kcal / kg (Toneladas)</option>" +
                        "<option value='carvao-vapor-sem-especificacao'>Carvão Vapor sem Especificação (Toneladas)</option>" +
                        "<option value='coque-de-carvao-mineral'>Coque de Carvão Mineral (Toneladas)</option>" +
                    "</select>"
...
var form_fuel_three = "<br><input class='form-fuel-three form-control' name='emission_three' value='Ar condicionado' readonly='readonly'> " +
                      "<br><input class='form-quantity-three form-control' name='emission_quantity_three' type='number' placeholder='Quantidade'>" +

                      "<br><input class='form-fuel-three form-control' name='emission_three' value='Extintores' readonly='readonly'>" +
                      "<br><input class='form-quantity-three form-control' name='emission_quantity_three' type='number' placeholder='Quantidade'>" +

                      "<br><input class='form-fuel-three form-control' name='emission_three' value='Geladeira'  readonly='readonly'>" +
                      "<br><input class='form-quantity-three form-control' name='emission_quantity_three' type='number' placeholder='Quantidade'>"
